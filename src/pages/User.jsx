        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 mb-8 md:gap-8">
            ...
            <div className="col-span-2">
                ...
                <div className="w-full rounded-lg shadow-md bg-base-100 stats">
                    {location && (
                        <div className="stat">
                            <div className="stat-md text-md">Location</div>
                    ...
                    {blog && (
                        <div className="stat">
                            <div className="stat-md text-md">Website</div>
                            <div className="text-lg stat-value">
                    ...
                    {twitter_username && (
                        <div className="stat">
                            <div className="stat-md text-md">Twitter</div>
                            <div className="text-lg stat-value">
        ...
        <div className="w-full py-5 mb-6 rounded-lg shadow-md bg-base-100 stats">
            <div className="stat">
                <div className="stat-figure text-secondary">
                    <FaUsers className='text-3xl md:text-5xl mt-2' />
                </div>
            ...
            <div className="stat">
                <div className="stat-figure text-secondary">
                    <FaUserFriends className='text-3xl md:text-5xl mt-2' />
                </div>
                <div className="stat-title pr-5">
                    Following
                </div>
            ...
            <div className="stat">
                <div className="stat-figure text-secondary">
                    <FaCodepen className='text-3xl md:text-5xl mt-2' />
                </div>
                <div className="stat-title pr-5">
                    Public Repos
                </div>
            ...
            <div className="stat">
                <div className="stat-figure text-secondary">
                    <FaStore className='text-3xl md:text-5xl mt-2' />
                </div>
                <div className="stat-title pr-5">
                    Public Gists
                </div>
